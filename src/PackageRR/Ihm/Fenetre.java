...
public class Fenetre extends JFrame implements IEcouteurModel {
	...
	public Fenetre() {
		...
		jlcible = new JLabel("CIBLE:" + plateau.getCibles()[cibleCourante].getCouleur() + " "
				+ plateau.getCibles()[cibleCourante].getForme());
	...
	public void modeleMisAJour(Object source) {
		...
		int cibleCourante = plateau.getCibleCourante();
		jlcible.setText("CIBLE:" + plateau.getCibles()[cibleCourante].getCouleur() + " "
				+ plateau.getCibles()[cibleCourante].getForme());
