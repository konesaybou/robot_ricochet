...
public class Maquette extends JComponent implements IEcouteurModel, MouseListener {
	...
	protected void paintComponent(Graphics g) {
		 ...
		 * Position posRobot
		 * =plateau.getListeRobot()[plateau.getRobotCourant()].getPosition();
		 * g2D.setStroke(new BasicStroke(3));
		 * g2D.drawRect((posRobot.getcol()+1)*DIM_CASE,
		 * (posRobot.getligne()+1)*DIM_CASE, DIM_CASE, DIM_CASE);
		 * }
		 */
	...
	public void positionnementImageR(Robot r, Graphics2D g2D) {
		if (r.getCouleur() == this.COULEUR[0])
			imgRR.paintIcon(null, g2D, (r.getPosition().getcol() + 1) * DIM_CASE,
					(r.getPosition().getligne() + 1) * DIM_CASE);
		if (r.getCouleur() == this.COULEUR[1])
			imgRJ.paintIcon(null, g2D, (r.getPosition().getcol() + 1) * DIM_CASE,
					(r.getPosition().getligne() + 1) * DIM_CASE);
		if (r.getCouleur() == this.COULEUR[2])
			imgRV.paintIcon(null, g2D, (r.getPosition().getcol() + 1) * DIM_CASE,
					(r.getPosition().getligne() + 1) * DIM_CASE);
		if (r.getCouleur() == this.COULEUR[3])
			imgRB.paintIcon(null, g2D, (r.getPosition().getcol() + 1) * DIM_CASE,
					(r.getPosition().getligne() + 1) * DIM_CASE);
	}
	...
	public void positionnementImageC(Cible c, Graphics2D g2D) {
		...
		if (c.getForme() == this.FORME[4] && c.getCouleur() == this.COULEUR[4])
			this.imgCbTobi.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
					(c.getPosition().getligne() + 1) * DIM_CASE);

		// Cibles rouge
		if (c.getCouleur() == this.COULEUR[0]) {

			if (c.getForme() == this.FORME[0])
				this.imgCbCercleR.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[1])
				this.imgCbEtoileR.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[2])
				this.imgCbTriangleR.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[3])
				this.imgCbLosangeR.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
		}
		// Cibles Jaune
		if (c.getCouleur() == this.COULEUR[1]) {
			...
			if (c.getForme() == this.FORME[0])
				this.imgCbCercleJ.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[1])
				this.imgCbEtoileJ.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[2])
				this.imgCbTriangleJ.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[3])
				this.imgCbLosangeJ.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
		}
		// Cibles Vert
		if (c.getCouleur() == this.COULEUR[2]) {
			...
			if (c.getForme() == this.FORME[0])
				this.imgCbCercleV.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[1])
				this.imgCbEtoileV.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[2])
				this.imgCbTriangleV.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[3])
				this.imgCbLosangeV.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
		}
		// Cibles Bleu
		if (c.getCouleur() == this.COULEUR[3]) {
			...
			if (c.getForme() == this.FORME[0])
				this.imgCbCercleB.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[1])
				this.imgCbEtoileB.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[2])
				this.imgCbTriangleB.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
			if (c.getForme() == this.FORME[3])
				this.imgCbLosangeB.paintIcon(null, g2D, (c.getPosition().getcol() + 1) * DIM_CASE,
						(c.getPosition().getligne() + 1) * DIM_CASE);
		}
	}
