...
public class Plateau extends ModelEcoutable {
	...
	private String[][] donnees = {
			/* 0 */ { "NULL", "NULL", "NULL", "NULL", "NULL", "010017", "000117", "NULL", "010017", "000117", "NULL",
					"NULL", "NULL", "NULL", "NULL", "NULL" },
			/* 1 */ { "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "010017", "001101",
					"NULL", "NULL", "NULL", "NULL", "NULL" },
			/* 2 */ { "NULL", "001017", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "100017",
					"NULL", "011012", "000117", "NULL", "NULL" },
			/* 3 */ { "010017", "100100", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL",
					"010017", "100111", "NULL", "NULL", "NULL" },
			/* 4 */ { "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "011005", "000117", "NULL", "NULL", "NULL",
					"NULL", "NULL", "NULL", "NULL", "001017" },
			/* 5 */ { "001017", "NULL", "001017", "NULL", "NULL", "NULL", "100017", "010017", "001116", "NULL", "NULL",
					"NULL", "NULL", "001017", "NULL", "100017" },
			/* 6 */ { "100017", "NULL", "110010", "001115", "NULL", "NULL", "NULL", "NULL", "100017", "NULL", "NULL",
					"NULL", "NULL", "110006", "000117", "NULL" },
			/* 7 */ { "NULL", "NULL", "NULL", "100017", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL",
					"NULL", "NULL", "NULL", "NULL" },
			/* 8 */ { "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL",
					"NULL", "NULL", "NULL", "NULL" },
			/* 9 */ { "NULL", "010017", "001104", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "011007",
					"000117", "NULL", "NULL", "NULL", "NULL" },
			/* 10 */{ "NULL", "NULL", "110009", "000117", "NULL", "NULL", "NULL", "001017", "NULL", "NULL", "100017",
					"NULL", "001017", "NULL", "NULL", "NULL" },
			/* 11 */{ "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "010017", "100114", "NULL", "NULL", "NULL",
					"NULL", "110002", "001108", "NULL", "NULL" },
			/* 12 */{ "001017", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "001017", "NULL",
					"NULL", "NULL", "100017", "NULL", "001017" },
			/* 13 */{ "100017", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "010017", "100113", "NULL",
					"NULL", "NULL", "NULL", "NULL", "100017" },
			/* 14 */{ "NULL", "NULL", "NULL", "NULL", "NULL", "011003", "000117", "NULL", "NULL", "NULL", "NULL",
					"NULL", "NULL", "NULL", "NULL", "NULL" },
			/* 15 */{ "NULL", "NULL", "NULL", "NULL", "NULL", "100017", "010017", "000117", "NULL", "NULL", "010017",
					"000117", "NULL", "NULL", "NULL", "NULL" },
	};
	...
	public Plateau() {
		...
		// collerPlateau(plateau, ligneGp, colonneGp, lignePp, colonnePp, MaxLigneGp,
		// MaxColonneGp);
		...
		// System.out.println(this.cibles[cibleCourante].getCouleur()+"
		// "+this.cibles[cibleCourante].getForme());
		this.robotCourant = 4;
	}
	...
	/**
	 * Cr�e une copie du plateau de jeu en se servant d'un noeud pour placer les
	 * robots
	 * utilis�e par A star pour obtenir les adjacents d'un noeud
	 * 
	...
	/**
	 * cr�e les petits plateaux de jeu en se servant du tableau "donnees"
	 * 
	 * @param ListPlateau  liste des 4 plateaux � rogner
	 ...
	 */
	public void creerPlateau(ArrayList<Case[][]> ListPlateau, int ligneDebut, int colonneDebut, int ligneFin,
			int colonneFin) {
	...
	/**
	 * Methode permettant d'assembler les 4 sous plateaux cr�es dans un seul plateau
	 * 
	...
	/**
	 * creation des fronti�res du jeu (murs)
	 */
	...
	/**
	 * creation des fronti�res de l'obstacle central
	 */
	...
	/**
	 * methode permettant de savoir si un objectif a �t� atteint
	 * 
	 * @return boolean
	 */
	...
	/**
	 * calcule et renvoie dans une liste les diff�rentes positions que peut prendre
	 * un robot � partir de sa position initiale
	 * 
		...
		for (int i = 0; i < this.nbRobot; i++) {
			...
			for (int k = 0; k < this.nbRobot; k++) {
				listeRobot[k].setPosition(
						new Position(listeRobotNoeuds[k].getPosition().getligne(),
								listeRobotNoeuds[k].getPosition().getcol()));
			}
